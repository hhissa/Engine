...
const char *vulkan_result_string(VkResult result, b8 get_extended) {
  ...
  case VK_THREAD_IDLE_KHR:
    return !get_extended
               ? "VK_THREAD_IDLE_KHR"
               : "VK_THREAD_IDLE_KHR A deferred operation is not complete but "
                 "there is currently no work for this thread to do at the "
                 "time of this call.";
  case VK_THREAD_DONE_KHR:
    return !get_extended
               ? "VK_THREAD_DONE_KHR"
               : "VK_THREAD_DONE_KHR A deferred operation is not complete but "
                 "there is no work remaining to assign to additional "
                 "threads.";
  ...
  case VK_ERROR_INITIALIZATION_FAILED:
    return !get_extended
               ...
               : "VK_ERROR_INITIALIZATION_FAILED Initialization of an object "
                 "could not be completed for implementation-specific "
                 "reasons.";
  ...
  case VK_ERROR_FRAGMENTED_POOL:
    return !get_extended
               ...
               : "VK_ERROR_FRAGMENTED_POOL A pool allocation has failed due "
                 "to fragmentation of the pool's memory.";
  ...
  case VK_ERROR_INCOMPATIBLE_DISPLAY_KHR:
    return !get_extended
               ...
               : "VK_ERROR_INCOMPATIBLE_DISPLAY_KHR The display used by a "
                 "swapchain does not use the same presentable image layout, "
  ...
  case VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT:
    return !get_extended
               ...
               : "VK_ERROR_FULL_SCREEN_EXCLUSIVE_MODE_LOST_EXT An operation "
                 "on a swapchain created with "
